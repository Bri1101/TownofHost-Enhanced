            ...
            if (target1 != null && target2 != null)
            {
                ...
                else
                {
                    ...
                    (
                        ...
                        ||
                        (
                        (Illusionist.IsCovIllusioned(target1.PlayerId) || (target1.GetCustomRole().IsCrewmateTeamV2() && (target1.GetCustomSubRoles().All(role => role.IsCrewmateTeamV2()) || target1.GetCustomSubRoles().Count == 0)) || target1.Is(CustomRoles.Admired)) && !target1.Is(CustomRoles.Bloodthirst)
                        &&
                        (Illusionist.IsCovIllusioned(target2.PlayerId) || (target2.GetCustomRole().IsCrewmateTeamV2() && (target2.GetCustomSubRoles().All(role => role.IsCrewmateTeamV2()) || target2.GetCustomSubRoles().Count == 0)) || target2.Is(CustomRoles.Admired)) && !target2.Is(CustomRoles.Bloodthirst)
                        )
                        ||
                        (
                        (target1.GetCustomRole().IsImpostorTeamV2() || target1.IsAnySubRole(role => role.IsImpostorTeamV2())) && !target1.Is(CustomRoles.Admired) && !target1.Is(CustomRoles.Bloodthirst)
                        &&
                        (target2.GetCustomRole().IsImpostorTeamV2() || target2.IsAnySubRole(role => role.IsImpostorTeamV2())) && !target2.Is(CustomRoles.Admired) && !target2.Is(CustomRoles.Bloodthirst)
                        )
                        ||
                        (
                        (target1.GetCustomRole().IsNeutralTeamV2() || target1.IsAnySubRole(role => role.IsNeutralTeamV2()) || target1.Is(CustomRoles.Bloodthirst)) && !target1.Is(CustomRoles.Admired)
                        &&
                        (target2.GetCustomRole().IsNeutralTeamV2() || target2.IsAnySubRole(role => role.IsNeutralTeamV2()) || target2.Is(CustomRoles.Bloodthirst)) && !target2.Is(CustomRoles.Admired)
                        )
                    )
                    {
                        _ = new LateTask(() =>
                    ...
                    if (InspectCheckTargetKnow.GetBool())
                    {
                        ...
                        if (InspectCheckRevealTargetTeam.GetBool() && pc.AllTasksCompleted())
                        {
                            ...
                            if (target1.Is(CustomRoles.Bloodthirst)) roleT1 = "Neutral";
                            ...
                            if (target2.Is(CustomRoles.Bloodthirst)) roleT1 = "Neutral";
